    ...
    <div class="l1-wrap fade-in">
      ...
      <div class="nb-header">
        <div class="nb-header-inner">
          ...
          <nav class="nb-menu">
            <span class="nb-menu-item nb-menu-item--active">전체글</span>
            <span class="nb-menu-item">팬게임</span>
            <span class="nb-menu-item">이야기</span>
            <span class="nb-menu-item">about</span>
          </nav>
        </div>
      </div>
      ...
      <div class="nb-body">
        ...
        <aside class="nb-sidebar">
          ...
          <div class="nb-widget">
            ...
            <div class="nb-widget-item">전체글 <span>12</span></div>
            <div class="nb-widget-item nb-widget-item--active">팬게임 <span>3</span></div>
            <div class="nb-widget-item">이야기 <span>9</span></div>
          </div>
          <div class="nb-widget">
